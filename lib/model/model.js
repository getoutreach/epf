...
Ep.Model = Ember.Object.extend(Ember.Copyable, Ep.ModelMixin, {
  ...
  // The clientId of a parent model. A model is the "parent" of another
  // model if the child model is inside a parent attribute
  _parentId: undefined,
  ...
  */
  ...
  copyMeta: function(dest) {
    ...
    set(dest, '_parentId', get(this, '_parentId'));
  }
