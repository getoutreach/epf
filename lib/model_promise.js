...
Orm.ModelPromise = Ember.ObjectProxy.extend(Orm.ModelMixin, Ember.DeferredMixin, {
  ...
  // TODO: do we need to pass through suspendRelationshipObservers?
  ...
  // TODO: we should be session-aware here and
  ...
  merge: function(dest, cache) {
    ...
    if(this.content) {
      return content.merge(dest, cache);
    }
    // NO-OP
    return dest;
  }
