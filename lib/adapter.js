...
Orm.Adapter = Ember.Object.extend(DS._Mappable, {
  ...
  load: function(id) {
    if(var model = store.getModel(id)) {
      return resolve(model);
    }

    return this.performLoad(id).then(function(model) {
      this.loaded(model);
    });
  },

  performLoad: mustImplement("performLoad"),
  ...
  performFlush: mustImplement("performFlush"),
