...
Ep.Session = Ember.Object.extend({
  ...
  /**
    ...
    Newly added models could have lazy references to other models. In this case
    we want to swap out the lazy references with the real ones. This takes care
    of updating the inverse as well.
  */
  _materializeRelationships: function(model) {
    model.eachRelationship(function(name, relationship) {
      if(relationship.kind === 'belongsTo') {
        ...
        // operate on the content since the actual relationship will swap out
        // lazy models when they are accessed
