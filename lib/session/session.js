...
Ep.Session = Ember.Object.extend({
  ...
  // TODO: this is for adding detached models, create new adopt method to handle this
  add: function(model) {
    Ember.assert("Models cannot be moved between sessions. Use `update` instead.", !get(model, 'session') || get(model, 'session') === this);
