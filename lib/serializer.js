...
Orm.Serializer = Ember.Object.extend({
  init: function() {
  ...
  deserializeHasMany: function(name, record, data, relationship) {
    var type = record.constructor,
        ...
        embeddedType = this.embeddededType(relationship, data),
  ...
  deserializeEmbeddedHasMany: function(name, model, values, relationship) {
    var result = Orm.ModelArray.create();
    var models = values.map(function(data) {
      var type = this.extractEmbeddedType(relationship, data);
      this.deserializeModel(type, data);
    }, this);
    set(result, 'content', models);
    set(model, name, result);
  },

  deserializeLazyHasMany: function(name, record, values, relationship) {
    var result = Orm.LazyModelArray.create();
    set(result, 'content', values);
    set(model, name, result);
  },
  ...
  deserializeEmbeddedBelongsTo: function(name, model, value, relationship) {
    var type = this.extractEmbeddedType(relationship, data);
    var child = this.deserializeModel(type, data);
